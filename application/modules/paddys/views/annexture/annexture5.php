...
?>        
 ...
 <div class="col-md-3 container"></div>
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("payment/annexture5");?>">
    ...
    ?>
        ...
        <div class="wraper"> 
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Annexure V</strong></h1>
                ...
                <tbody> 
                    ...
                    ?>
                            ...
                            <tr>
                               ...
                               <!--  <td><?php //echo round(($bill_dtl->paddy_qty*$charges->rate),2);?></td> -->
                             
                                <td>
                                
                                    <a href="<?php echo base_url();?>index.php/payment/annexture5_print?pmt_bill_no=<?php echo $bill_dtl->pmt_bill_no; ?>" 
                                        data-toggle="tooltip"
