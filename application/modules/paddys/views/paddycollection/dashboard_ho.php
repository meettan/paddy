...
?>        
    ...
    <div class="row">
        ...
        <div class="col-lg-12 container contant-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("paddys/transactions/f_paddycollection_dwn");?>" >
...
<div class="wraper">      
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Download Paddy Procurement By <?php if($this->input->post("trans_type")=="N"){
                   ...
                   foreach($paddycollection_dtls as $padl_dtl)
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo get_district_name($padl_dtl->branch_id);?></td>
                          ...
                          <td><?php  if($padl_dtl->bank_id == 1){
                            ...
                            <td style="text-align: ;">
                                ...
                                <?php if($padl_dtl->certificate_3=="Y") {?>
                                    <a href="<?php echo base_url()?>index.php/paddys/transactions/f_paddy_procurement_Excel/<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>/<?=$padl_dtl->bulk_trans_id;?>/<?=$padl_dtl->chq_status;?>" target="_blank" title="Download" id="btn" class="download btn btn-success" ><i class="fa fa-file-text-o fa-lg" aria-hidden="true"></i></a>
