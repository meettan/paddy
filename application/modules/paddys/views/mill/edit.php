    ...
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper" style="margin-left: 0px;">
            ...
            <form method="POST"  id="form" 
                ...
                action="<?php echo site_url("paddys/add_new/f_mill_edit");?>"  onsubmit="return validate_form();" >
                ...
                <input type="text" class="form-control"  name ="boiler_reg_no"  required
                id="boiler_reg_no" value="<?php echo $mill_dtls->boiler_reg_no;?>" />
                ...
                id="pan" value="<?php echo $mill_dtls->ph_no;?>" />
                    ...
                    <input type = "text" class= "form-control" required name ="tan" id="tan" value="<?php echo $mill_dtls->tan;?>"/>
                    ...
                    <input type= "text" class="form-control" name="post_office" id="post_office" value="<?php echo $mill_dtls->post_office;?>"/>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <textarea type = "text"
                            class= "form-control" required
                            name= "addr"  id= "addr"><?php echo $mill_dtls->mill_addr;?></textarea>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                name="select-all" id="select-all"> All</th>
                                <th>Sl. No.</th>
                                <th>Documents</th>
                        ...
                        <tbody> 
                         ...
                         if(isset($mill_dtls));
                         {
                         $guide=explode(",",$mill_dtls->guide_lines_id);
                         }
                        ...
                        <tr>
                         ...
                         <td><input type="checkbox" class="form-check-input checkbox" name="guide_lines_id[]" value="<?php if(isset($guideline->sl_no)){ echo $guideline->sl_no;}?>" <?php if (in_array($guideline->sl_no, $guide)) {  echo "checked";} ?> ></td> 
                         <td><?=$i++?></td>
