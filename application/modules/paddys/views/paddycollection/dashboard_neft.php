...
?>        
    ...
    <div class="row">
        ...
        <div class="col-lg-12 container contant-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("paddys/transactions/f_neft_status");?>" >
                 ...
                 <div class="form-group row">
                   ...
                   <select name="branch" id="branch" class="form-control" required>
                            ...
                            foreach($branches as $branch) {   
                             ...
                             ?> 
                            <option value="<?php if(isset($branch->id)){ echo $branch->id; }?>"><?php if(isset($branch->branch_name)){ echo $branch->branch_name; }?></option> 
...
<div class="wraper">   
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Neft Status</strong></h1>
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <table class="table table-bordered table-hover" id="myTable">
                ...
                <?php 
                   ...
                   $count=0;
                   foreach($paddy_dtls as $padl_dtl)
                        {
                       ?>
                        <tr>
