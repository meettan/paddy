...
?>        
 ...
 <div class="col-md-3 container"></div>
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("payment/annexture8");?>">
    ...
    ?>
        ...
        <div class="wraper"> 
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Annexure VIII</strong></h1>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url();?>index.php/payment/annexture8_print?pmt_bill_no=<?php echo $bill_dtl->pmt_bill_no; ?>/<?php echo $bill_dtl->dist; ?>/<?php echo $bill_dtl->kms_id; ?>" 
                                        data-toggle="tooltip"
