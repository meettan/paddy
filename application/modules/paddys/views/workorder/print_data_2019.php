  ...
  <tbody>
    ...
    <tr>
      <td width="30%" valign="top" style="padding-top: 25px;"><p style="margin: 0; padding: 0; line-height: 20px;">To	<br>The Chairman/Secretary/Manager,<br>
		...
		<td style="text-align: left; padding: 59px 10px 5px 10px; font-family: arial; font-size: 15px; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tbody>
		    <tr>
			  ...
			  Memo. No. <strong style="text-transform: uppercase;"><?=$workorder_dtls->pre_order_no;?><?=$workorder_dtls->order_no;?></strong><br></p></td>
		...
		<td style="text-align: left; padding: 10px; font-family: arial; font-size: 15px;">
	      ...
	      <ol style="margin: 0; padding: 0 0 0 15px;">
		      ...
		      <li style="padding: 0 0 10px 0; margin: 0; font-size: 15px;">The District Controller of Food & Supplies, <strong><?php if(isset($this->session->userdata['loggedin']['branch_name'])){ echo $this->session->userdata['loggedin']['branch_name'];}?></strong> district </li>
		        ...
		        <li style="padding: 0 0 10px 0; margin: 0; font-size: 15px;">Sri/ Smt. ______________________________________,<?php echo $workorder_dtls->mill_name;?>. He/She is requested to supply the required equipment, remain present or send authorized representative at the procurement camp and arrange to receive the paddy procured on the day itself from the camp to your tagged rice mill and extend all cooperation to the procuring Cooperative Society such that social distancing and other safety measures may be taken. Also you are requested to mill paddy as per Government instruction and tripartite agreement so that &#8216;Offer&#8217; and &#8216;Delivery&#8217; of the entire resultant CMR is completed within the stipulated time.</li>
	      </ol>
