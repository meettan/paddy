...
class Payment extends MX_Controller {
    ...
    public function f_commission(){
        ...
        $commission['commission_dtls']    =   $this->Paddy->f_get_particulars("td_society_commision c,md_society s,td_fund_requisition d", NULL, $where, 0);
