<div class="wraper">      
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Approve Paddy Procurement</strong></h1>
                ...
                <?php 
                   ...
                   foreach($paddycollection_dtls as $padl_dtl)
                       ...
                       ?>
                        ...
                        <a href="<?php echo base_url()?>index.php/paddys/transactions/f_checker_update?soc_id=<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>" data-toggle="tooltip"
                                    data-placement="bottom"  title="Edit">

                                    <i class="fa fa-edit fa-2x" style="color: #007bff"></i>
                                    
                                </a>
                                <?php if($padl_dtl->certificate_3=="Y") {?>
                                   
<a href="<?php echo site_url("paddys/transactions/f_paddycollection_print");?>?soc_id=<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>" 
            data-toggle="tooltip" data-placement="bottom" title="Print">
            <i class="fa fa-print fa-2x" style="color: #007bff"></i></a>  
<!-- <a href="<?php //echo site_url("paddys/transactions/f_masterroll_print");?>?soc_id=<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>/<?=$padl_dtl->status;?>" 
        data-toggle="tooltip" data-placement="bottom" title="Print Master Roll"><i class="fa fa-print fa-3x" style="color: #007bff"></i></a> -->

<?php }?></td>
                        
<td>  
                        <?php if($padl_dtl->certificate_1=="Y" && $padl_dtl->certificate_2=="Y" && $padl_dtl->certificate_3=="Y"){ ?>
                            <a href="<?php echo site_url("paddys/transactions/f_paddycol_ho_forward");?>?soc_id=<?=$padl_dtl->soc_id;?>/<?=$padl_dtl->trans_dt;?>"><button class="btn btn-primary" id="">Forward</button></a>
